...
//      }
      ...
      "decrypt through a filter" in {
        val bodyEncrypted = Hex.toHexString(Encryption.send(TestVariables.incoming_body_plain,
          Encryption.getServerPublicKey))
        Post("/decryption", bodyEncrypted).withHeaders(HttpHeader.parse("encryption_type", "public")
            .asInstanceOf[ParsingResult.Ok].header) ~> TestServlet.route ~> check {
...
private[security] object TestServlet {
  ...
  def getSendersPublicKey: String = "-----BEGIN PUBLIC KEY-----\\n-----END PUBLIC KEY-----"
}